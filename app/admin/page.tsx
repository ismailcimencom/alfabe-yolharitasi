...
import { ChevronRight, CheckCircle, PlayCircle, ListChecks, UserPlus, LogOut, Users, UserCheck, User, BarChart3, MessageCircle, ChevronUp, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* 🔽 BEKLEYEN YAZILIMCILAR - TOGGLE'LI */}
        ...
        {activeMembers.length > 0 && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-8">
            ...
            >
              ...
              {showActive ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
            </button>
        ...
        {inactiveMembers.length > 0 && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-8">
            ...
            >
              ...
              {showInactive ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
            </button>
...
// IdeasTable Komponenti - DÜZELTİLMİŞ (hatalı ) satırı kaldırıldı)
